...
for beta in beta_array:
    all, times = ImportData(f"Random_Couplings/ISO__Random__N=12__beta={beta:.2g}__numConfigs=1000")
    ...
    plt.errorbar(times, G, yerr=G_err, ls='--', label = rf'Chebyshev, $\beta J_Q$={beta:.2g}', marker=markers[i], markevery=25)
    i+=1
...
plt.savefig("Plots/spinDMFT_Random.pdf", dpi=1000)
plt.clf()
