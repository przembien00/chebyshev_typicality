...
for( int k=0; k < my_pspace.num_Vectors_Per_Core; k++ )
{
    ...
    func::compute_correlations_at( 0, 0, my_pspace, psi_L, v_psi_R, new_correlations_R, new_correlations_I, new_correlations_R_sq, new_correlations_I_sq );
    for( uint t_point = 1; t_point < my_pspace.num_TimePoints; t_point++ )
    {
        ...
        func::compute_correlations_at( t_point, 0, my_pspace, psi_L, v_psi_R, new_correlations_R, new_correlations_I, new_correlations_R_sq, new_correlations_I_sq ); // <psi_0|e^(-beta H/2) e^(tau H) S^a_0 e^(-tau H) S^b_0 e^(-beta H/2)|psi_0>
    }
