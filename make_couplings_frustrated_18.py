...
pbc_nn_pairs = [(0, 11), (0, 15), (2, 15), (2, 17), (6, 11), (6, 17),
             (1, 6), (1, 12), (5, 12), (5, 16), (11, 16) ]
pbc_nnn_pairs = [(0, 10), (0, 6), (2, 14), (6, 16), (10, 16), (1, 7), (1, 11), (5, 13), 
                (11, 17), (7, 17), (4, 12), (3, 15)]
for i, j in pbc_nn_pairs:  
    couplings[i, j] = 1
    couplings[j, i] = 1

# Save as HDF5
with h5.File("Couplings/Square_Frustrated_PBC_N=18.hdf5", "w") as f:
