...
colors =  ['red', 'lightcoral', 'lightpink', 'lightskyblue', 'dodgerblue', 'mediumblue']
...
for beta in beta_array:
    ...
    ax.plot(times_sdmft, G_sdmft, label = rf'$T/kJ_Q$={1/beta:.2g}', color=colors[i], markevery=25)
...
ax.set_xlim(0, 1)
ax.set_ylim(0.18, 0.252)

ax.legend()

fig.savefig("Plots/SDMFT_stusti.pdf", dpi=1000)
